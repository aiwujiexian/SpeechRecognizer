...
print("Done.")
print("==================================================")
#print("|            The longest speech           |", wav_max_len, " |")
print("|              Samples number             |", len(wav_files), "|")
print('|             Vocabulary size             |', words_size, "|")
print('| The word number of the longest sentence |', label_max_len, "  |")
print("==================================================")
'''
batch_size = 1
...
def speech_to_text_network(n_dim=128, n_blocks=3):
    with tf.name_scope("Network"):
        ...
        logit = conv1d_layer(logit, size=1, dim=2666, activation=None, scale=0.04, bias=True)
...
def train_speech_to_text_network():
    ...
    model_dir = "./checkpoint/" + datetime.datetime.now().strftime("%Y%m%d-%H%M%S") + "/"
    ...
    with tf.name_scope("Train"):
        ...
        for epoch in range(15):
            ...
            for batch in range(n_batch):
                ...
                print(" "+time+":"+" Batch:{} Average Loss:{:.4f}".format(batch+1, _loss))
                writer.add_summary(summary, (batch+1) * (epoch+1))
